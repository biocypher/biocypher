...
class Graph:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        hyperedge_type_dist = {hyperedge_type: len(hyperedges) 
                              for hyperedge_type, hyperedges in self._hyperedge_types.items()}
    ...
    def __str__(self) -> str:
        ...
        return (f"Graph(name='{self.name}', nodes={stats['basic']['nodes']}, "
