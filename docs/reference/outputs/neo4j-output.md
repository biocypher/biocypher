...
neo4j:  ### Neo4j configuration ###
  ...
  # If unset, BioCypher uses the output directory where the CSV files were written.
...
CSV part files. Configure `import_call_file_prefix` only when the files will be
