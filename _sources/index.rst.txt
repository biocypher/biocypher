...
- A graph database can be built from any arbitrary collection of biomedical data. 
  ...
  OmniPath database (cite), but BioCypher includes the extensive translation 
  functionality from PyPath to accommodate custom requirements for graph database 
  contents.
